...
const Header2 = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto h-16 rounded-full px-4 py-2 bg-[#14141466] backdrop-blur-[30px] backdrop-saturate-150 z-20 border border-white/10 shadow-[0_10px_40px_#0003] transition-colors duration-300 text-white">
      <div className="h-full flex justify-between items-center px-4">
        ...
        >
          <span className="font-extrabold tracking-tighter">T</span>Movies
        </div>
    ...
    <div>
      <nav className="h-20 w-full flex items-center py-12 my-0 rounded-b-4xl bg-sky-100 dark:bg-slate-950 sticky top-0 z-50">
        <div className="max-w-7xl w-full mx-auto flex items-center justify-between">
          <div
            className="font-semibold text-3xl bg-linear-to-r from-rose-800 via-pink-400 to-rose-800 bg-clip-text text-transparent dark:from-pink-400 dark:via-rose-400 dark:to-pink-400 hover:scale-115 cursor-pointer 
          transition-all duration-500"
          >
